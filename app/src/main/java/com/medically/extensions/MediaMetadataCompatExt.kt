 ...
 * our constructed object (to make the code a bit easier to see).
 */
fun MediaMetadataCompat.Builder.subject(subject: String?): MediaMetadataCompat.Builder {
    genre = subject

    return this
}

fun MediaMetadataCompat.Builder.chapter(chapter: Chapter?): MediaMetadataCompat.Builder {
    album = chapter?.name
    albumArtUri = chapter?.imageUrl
    displayDescription = chapter?.name
    displayIconUri = chapter?.imageUrl

    return this
}

fun MediaMetadataCompat.Builder.doctor(doctorName: String?): MediaMetadataCompat.Builder {
    artist = doctorName
    displaySubtitle = doctorName
    return this
}
...
fun MediaMetadataCompat.Builder.lecture(
    ...
    trackCount = totalTrackCount.toLong()
    flag = MediaItem.FLAG_PLAYABLE

    // To make things easier for *displaying* these, set the display properties as well.
    displayTitle = lecture.name
